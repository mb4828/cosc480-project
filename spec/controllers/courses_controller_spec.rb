...
Rspec.describe CoursesController, type: :controler do

  describle "root route" do 
 ...
 describe "GET #index" do
  ...
  describe "create new course" do 
    ...
    it "should show success flash message and redirect to index upon successful creation" do
      ...
      post :create, {:course => ("name" => "intro", "description" => "cosc 101", "sunday" => false, "monday" => true, "tuesday" => false, "wednesday" => true, "thursday" => false, "friday" => true, "saturday" => false, "start_time" => "10:20am", "end_time" => "11:10am"}
  ...
  describe "Update a course" do 
    ...
    it "should show success flash message and redirect to index upon successful update" do
      ...
      put :update, {:course => ("id" => "1", "name" => "intro", "description" => "cosc 101", "sunday" => false, "monday" => true, "tuesday" => false, "wednesday" => true, "thursday" => false, "friday" => true, "saturday" => false, "start_time" => "10:20am", "end_time" => "11:10am"}
      expect(response).to redirect_to (schedule_courses_path)
      flash['notice'] != nil
    end
  ...
  describe "delete a  course" do 
    ...
    it "should show success flash message and redirect to index upon successful deletion" do
      ...
      delete :destroy, {:course => ("id"=>"1","name" => "intro", "description" => "cosc 101", "sunday" => false, "monday" => true, "tuesday" => false, "wednesday" => true, "thursday" => false, "friday" => true, "saturday" => false, "start_time" => "10:20am", "end_time" => "11:10am"}
      expect(response).to redirect_to (schedule_courses_path)
      flash['notice'] != nil
    end
