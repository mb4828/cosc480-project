var schedulescripts = (function() {
  ...
  return {
    ...
    makeBox: function(id, day, desc, start, end){
    ...
    createSchedule: function(id){
        ...
        if ($("#course-"+id+"-sun").text() == "true") this.makeBox(id, 'sun', desc, start, end);
        if ($("#course-"+id+"-mon").text() == "true") this.makeBox(id, 'mon', desc, start, end);
        if ($("#course-"+id+"-tue").text() == "true") this.makeBox(id, 'tue', desc, start, end);
        if ($("#course-"+id+"-wed").text() == "true") this.makeBox(id, 'wed', desc, start, end);
        if ($("#course-"+id+"-thu").text() == "true") this.makeBox(id, 'thu', desc, start, end);
        if ($("#course-"+id+"-fri").text() == "true") this.makeBox(id, 'fri', desc, start, end);
        if ($("#course-"+id+"-sat").text() == "true") this.makeBox(id, 'sat', desc, start, end);
